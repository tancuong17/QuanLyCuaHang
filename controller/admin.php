...
$stamentPrice = $connect->prepare("SELECT product.id, product.name, price.price, price.start_date, price.end_date FROM price INNER JOIN product on price.id_product = product.id");
