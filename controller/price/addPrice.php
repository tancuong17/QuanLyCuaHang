<?php
    ...
    if($row['count'] == 0){
        ...
        $check = $stament->execute([null, $idProduct, $price, $startDate, $endDate, date("Y-m-d H:i:s")]);
        ...
        echo json_encode(array("result" => 1,  "id" => $id, "idProduct" => $idProduct, "nameProduct" => $nameProduct, "price" => $price, "startDate" => $startDate, "endDate" => $endDate, "date" => date("Y-m-d H:i:s")));
    }
    else{
